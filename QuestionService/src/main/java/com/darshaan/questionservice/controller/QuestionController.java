package com.darshaan.questionservice.controller;
...
import com.darshaan.questionservice.service.QuestionService;
...
public class QuestionController {
	...
	{
		return questionService.getQuestionsForQuiz(categoryName);
	}
